 <?php 
	$result= 0.006*((($_POST["tsalary1"]/$_POST["tdays1"])+($_POST["tsalary2"]/$_POST["tdays2"])+($_POST["tsalary3"]/$_POST["tdays3"])+($_POST["tsalary4"]/$_POST["tdays4"])+($_POST["tsalary5"]/$_POST["tdays5"])+($_POST["tsalary6"]/$_POST["tdays6"])+($_POST["tsalary7"]/$_POST["tdays7"])+($_POST["tsalary8"]/$_POST["tdays8"])+($_POST["tsalary9"]/$_POST["tdays9"])+($_POST["tsalary10"]/$_POST["tdays10"]))/10)* $_POST["total_days"]; 
...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<a href="./pension.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp >Υπολογισμός Ποσού Σύνταξης</a>
	<a href="./pension.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp>Φόρμα στοιχείων</a>	
	<a href="./pension_result.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp >Τελικό Ποσό Σύνταξης</a>
	
     <!-- main content (Slider sto CSS)-->
    <section id="slider" class="clear">
      <figure>
        <figcaption style="height:260px">
			<h2><b>Υπολογισμός Σύνταξης</b></h2>							  								
			<br><br><br>
			<b><h3 style="text-align:center">Το μηνιαίο ποσό της σύνταξης ανέρχεται στο ποσό των  <?php echo $result; ?>&#8364;</h3></b>
			<br><br>
			<b><h3 style="text-align:center">Κατώτατο Όριο Βασικού Ποσού Σύνταξης	486.84 €</h3></b>
			<br><br>
			<form action="./pension.php" style="margin"><input type="submit" class="btnRegister" value="Προηγούμενο" style="align:center"></form>
