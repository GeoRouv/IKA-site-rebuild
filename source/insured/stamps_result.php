 <?php 
		$result = ceil ((($_POST["total_days"])/24) * 25);
 ?>
...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<a href="./stamps_result.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp>Συνολικά Ένσημα</a>
    ...
    <section id="slider" class="clear">
      <figure>
        <figcaption style="height:260px">
			...
			<br><br><br>
			<b><h3 style="text-align:center">Το συνολικό πλήθος των ενσήμων σας ανέρχεται στα <?php echo $result; ?></h3></b>
			<br><br>
			<form action="./stamps.php" style="margin"><input type="submit" class="btnRegister" value="Προηγούμενο" style="align:center"></form>
