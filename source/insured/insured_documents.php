...
if(!empty($_POST["check"]))
{
	...
	{
		if(empty($_POST[$key])){
			$error_message = "Όλα τα πεδία είναι υποχρεωτικά!";
			break;
		}
	}
...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<a href="./insured_documents.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp>Βεβαίωση Ενσήμων</a>
	
     <!-- main content (Slider sto CSS)-->
    <section id="slider" class="clear">
      <figure>
        <figcaption style="height:970px;">
			<h2><b>Βεβαίωση Ενσήμων</b></h2>
			<form name="frm" method="post" action="">
				<table class="demo-table">
					...
					if(isset($login_session)){
						...
						echo '" max="99999999999"> </td>';
					    echo "<td>(11 ψηφία)</td>";
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Α.Μ.Α: </td>";
						echo '<td> <input type="number" name="AMA" class="demoInputBox" value="';
						if(isset($row->AMA)) echo $row->AMA;
						echo '" max="99999999999"> </td>';
					    echo "<td>(7 ψηφία)</td>";
						echo "</tr>";
						...
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:11px; font-family:Georgia, Times, serif;".">*Όλα τα πεδία είναι υποχρεωτικά.</td>";
						echo "</tr>";
