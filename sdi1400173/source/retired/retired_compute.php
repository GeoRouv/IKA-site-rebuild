<?php 
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		if($_POST['pen_institution']==1){
			if($_POST['pen_product']==1)
				header("location: ./pension.php");
			else if($_POST['pen_product']==2)
				header("location: ./pension.php");
			else if($_POST['pen_product']==3)
				header("location: ./pension.php");
			else if($_POST['pen_product']==4)
				header("location: ./retired_compute_ika4.php");
		}
		else if($_POST['pen_institution']==2){
			if($_POST['pen_product']==1)
				header("location: ./pension.php");
			else if($_POST['pen_product']==2)
				header("location: ./pension.php");
				...
				header("location: ./retired_compute_eteam4.php");
		}
...
#container #slider figure figcaption a{color:#FFFFFF; background-color:#464646;}
</style>
...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<a href="../index.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp>Συνταξιούχοι</a>
	<a href="../index.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp>Υπολογισμός Ποσού Σύνταξης</a>

     <!-- main content (Slider sto CSS)-->
    <section id="slider" class="clear">
      <figure>
        <figcaption style="height:550px;">
			<h2><b>Υπολογισμός Ποσού Σύνταξης</b></h2>
					<table class="demo-table">
						<tr>
							<td>
								...
								<table class="demo-table">
									<tr>
										<td><b>Συνταξιοδοτικός Φορέας:</b></td>
										<td>
											<select  name="pen_institution" size="2" width="200" style="background-color:#fbfbfb;width:200px;">
												<option value="1" selected>IKA-ΕΤΑΜ 
												<option value="2">ΕTEAM 
											</select>
										</td>
									</tr>
									<tr>
										<td><b>Τύπος Σύνταξης:</b></td>
										<td >
											<select  name="pen_product" size="4" width="200" style="background-color:#fbfbfb;width:200px;">
												<option value="1" selected>ΓΗΡΑΤΟΣ 
												<option value="2">ΑΝΑΠΗΡΙΑΣ 
												<option value="3">ΘΑΝΑΤΟΥ ΑΣΦΑΛΙΣΜΕΝΟΥ 
												<option value="4">ΘΑΝΑΤΟΥ ΣΥΝΤΑΞΙΟΥΧΟΥ 
											</select>
										</td>
									</tr>
									<tr><td height=50 colspan="2" align=center ><input type="submit" name="next" value="Επόμενο" class="btnRegister"></td></tr>
								</table>
								</form>
							</td>
						</tr>
