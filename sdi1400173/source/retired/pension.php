...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<a href="./pension.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp>Φόρμα στοιχείων</a>
	

     <!-- main content (Slider sto CSS)-->
    <section id="slider" class="clear">
      <figure>
        <figcaption style="height:860px">
			<h2><b>Υπολογισμός Σύνταξης</b></h2>							  								
			<table class="demo-table">
				<tr>
					<td>
						<form name="form1" action="./pension_result.php" method="post" autocomplete="off">
							<table class="demo-table">
								<tr>
									<td>
										<table class="demo-table">
											<tr><td colspan="2" ><b>ΥΠΟΛΟΓΙΣΜΟΣ ΒΑΣΙΚΟΥ ΠΟΣΟΥ ΣΥΝΤΑΞΗΣ</b></td></tr>	
											<tr>
											...
											<tr>
												<td align="center">
												<b>Στοιχεία τελευταίας δεκαετίας:</b>
												</td>
												<td>
													<table class="demo-table">
														<tr>
															<td align="center"><b>Έτος</b></td>
															<td align="center"><b>Αποδοχές<br>(&euro;)</b></td>
															<td align="center"><b>Ημέρες Εργασίας</b></td>
														</tr>															
														<tr>
															<td >2017</td>				
															<td ><input class="number" size="15" name="tsalary1" value="" required></td>
															<td ><input class="number" size="15" name="tdays1" value="" required></td>				
														</tr>

														<tr>
															<td >2016</td>			
															<td ><input class="number" size="15" name="tsalary2" value="" required></td>
															<td ><input class="number" size="15" name="tdays2" value="" required></td>				
														</tr>

														<tr>
															<td >2015</td>				
															<td ><input class="number" size="15" name="tsalary3" value="" required></td>
															<td ><input class="number" size="15" name="tdays3" value="" required></td>
			
														</tr>

														<tr>
															<td >2014</td>				
															<td ><input class="number" size="15" name="tsalary4" value="" required></td>
															<td ><input class="number" size="15" name="tdays4" value="" required></td>
			
														</tr>

														<tr>
															<td >2013</td>				
															<td ><input class="number" size="15" name="tsalary5" value="" required></td>
															<td ><input class="number" size="15" name="tdays5" value="" required></td>
			
														</tr>

														<tr>
															<td >2012</td>				
															<td ><input class="number" size="15" name="tsalary6" value="" required></td>
															<td ><input class="number" size="15" name="tdays6" value="" required></td>			
														</tr>

														<tr>
															<td >2011</td>				
															<td ><input class="number" size="15" name="tsalary7" value="" required></td>
															<td ><input class="number" size="15" name="tdays7" value="" required></td>
			
														</tr>

														<tr>
															<td >2010</td>				
															<td ><input class="number" size="15" name="tsalary8" value="" required></td>
															<td ><input class="number" size="15" name="tdays8" value="" required></td>
			
														</tr>

														<tr>
															<td >2009</td>				
															<td ><input class="number" size="15" name="tsalary9" value="" required></td>
															<td ><input class="number" size="15" name="tdays9" value="" required></td>
			
														</tr>

														<tr>
															<td>2008</td>				
															<td><input class="number" size="15" name="tsalary10" value="" required></td>
															<td><input class="number" size="15" name="tdays10" value="" required></td>			
														</tr>

													</table>
												</td>
											</tr>
											<tr><td height=37 colspan="2" align=center><form action="./pension_result.php"><input type="submit" class="btnRegister" value="Επόμενο" ></form></td></tr>
										</table>
									</td>
								</tr>
							</table>
						...
						<b>Σημειώσεις :</b>
						<ul>
						<li>Για να υπολογίσετε τις αποδοχές κάθε έτους θα πρέπει στο σύνολο των μεικτών αποδοχών κάθε μήνα να προσθέσετε τις τυχόν καταβληθείσες υπερωρίες, τα αναδρομικά και τα bonus.
						<li>Αν έχετε λάβει επίδομα ισολογισμού, θα πρέπει να διαιρεθεί δια 12 και να προστεθεί ανά μήνα στις αποδοχές του προηγούμενου της καταβολής έτους.
						<li>Επίσης, αν έχετε λάβει αναδρομικά και bonus που αντιστοιχούν σε ολόκληρο έτος, θα πρέπει να διαιρεθούν δια 12 και να προστεθούν σε κάθε μήνα του έτους στο οποίο αναφέρονται.
						<li>Στις παραπάνω αποδοχές δεν θα υπολογίσετε Δώρα Χριστουγέννων και Πάσχα, επιδόματα άδειας και τυχόν επίδομα ασθένειας.
						<li>Οι ημέρες εργασίας που λαμβάνονται υπόψη στην δεκαετία είναι το σύνολο των ημερών εργασίας κάθε έτους, αφαιρουμένων των ημερών ασθένειας.
						</ul>
