	...
	if(!isset($error_message))
	{
		if(isset($login_session)){
			...
			if($result <= 1)
			{
				...
				$query = "UPDATE users SET group_type = 'Συνταξιούχος' WHERE username='".$login_session."' " ;
				$result = $db_handle->updateQuery($query);
				
				$query = "UPDATE users SET last_insurance = '" . $_POST["last_insurance"] . "', name = '" . $_POST["firstName"] . "', surname = '" . $_POST["lastName"] . "', email = '" . $_POST["userEmail"] . "', AFM = '" . $_POST["AFM"] . "',AMKA = '" . $_POST["AMKA"] . "',phone = '" . $_POST["phone"] . "',city = '" . $_POST["city"] . "',region = '" . $_POST["region"] . "',address = '" . $_POST["address"] . "' WHERE username='".$login_session."' " ;
				$result = $db_handle->updateQuery($query);
...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<a href="./retired_applications.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp>Αίτηση Συνταξιοδότησης</a>
	
     <!-- main content (Slider sto CSS)-->
    <section id="slider" class="clear">
      <figure>
        <figcaption style="height:1230px;">
			<h2><b>Αίτηση Συνταξιοδότησης</b></h2>
			<form name="frmRegistration" method="post" action="">
				<table class="demo-table">
					...
					if(isset($login_session)){
						...
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Επώνυμο κατά τη γέννηση: </td>";
						echo '<td> <input type="text" name="birth_lastName" class="demoInputBox" value="';	
						if(isset($row->birth_surname)) echo $row->birth_surname;
						echo '" maxlength="50" required> </td>';
						echo "</tr>";
						...
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Τελευταίος Φορέας Ασφάλισης: </td>";
						echo '<td> <input  type="text" name="last_insurance" class="demoInputBox" value="';
						if(isset($row->last_insurance)) echo $row->last_insurance;
						echo '" maxlength="15" required> </td>';
						echo "</tr>";
						...
						echo '" max="9999999999" required> </td>';
						echo "<td>(10 ψηφία)</td>";
						echo "</tr>";
						...
						echo '<button name="submit" style="margin:0px 50px;" type="submit" value="HTML" class="btnRegister">Υποβολή</button>
						</form> ';
						echo "</td></td>";
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:11px; font-family:Georgia, Times, serif;".">(Σημείωση:Όλα τα πεδία είναι υποχρεωτικά.)</td>";
						echo "</tr>";
