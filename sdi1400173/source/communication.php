...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<a href="communication.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp>Επικοινωνία</a>

     <!-- main content (Slider sto CSS)-->
    <section id="slider" class="clear">
      <figure>
        <figcaption style="height:700px";>
          <h2><b>Επικοινωνία</b></h2>
          <ul style="list-style-type:disc">
            <li><h3>Τηλεφωνική Επικοινωνία</h3></li>
            <ul style="list-style-type:square">
              <li><p><b>25632460</b> (Από 9 π.μ. μέχρι 3 μ.μ. Δευτέρα με Παρασκευή)
              <br/>
              Ασφαλίσεις
              <br/>
              Συντάξεις
              ...
              <br/>
              Ανεργία</li>
              <li><p><b>25632461</b> (Από 9 π.μ. μέχρι 3 μ.μ. Δευτέρα με Παρασκευή)
              <br/>
              Ιατρικά
              <br/>
              Αναπηρεία
              ...
              Ασθένεια
              <br/>
              Κατ'οίκων φροντίδα</li>
              </p>
            </ul>
            
            <br/>
            <li><h4>Ηλεκτρονικό Ταχυδρομείο</h4></li>
            <p>akpservice@akp.gr</p>
            ...
            <br/>
            <li><h6>English-speaking Customers</h6></li>
            <p><b>25632465</b> (From 9 a.m. to 3 p.m. Monday to Friday)</p>

            <br/>
            <li><h6>Χρεώσεις</h6></li>
            <p>Οι τηλεφωνικές χρεώσεις ακολουθούν τα πρότυπα χρεώσεων του παρόχου του εκάστοτε καλούντος.</p>
        </ul>
