...
if(!empty($_POST["update-user"]))
{
	if(!isset($error_message))
	{
		...
		if($result <= 1)
		{
			...
			{
				$error_message = "";
				$success_message = "Αλλαγή στοιχείων επιτυχής!";	
				$_SESSION['login_user'] = $_POST["userName"];
				$login_session = $_POST["userName"];
				unset($_POST);
			}
			else 
				$error_message = "Πρόβλημα κατά την αλλαγή στοιχείων. Δοκιμάστε ξανά!";	
		}
		else
...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<a href="./edit_profile.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >>Επεξεργασία Προφίλ</a>

     <!-- main content (Slider sto CSS)-->
    <section id="slider" class="clear">
      <figure>
        <figcaption style="height:1070px;">
			...
			<table border="0" width="500" align="center" class="demo-table">
				...
				{ ?>	
					...
					</br><a href="./profile.php" style="text-decoration: underline;  color:#000000; background-color:#fff1f2;" >Επιστροφή στο προφίλ.</a></div>
				<?php } ?>									
				...
				if ($result = $db->query("SELECT * FROM users WHERE username = '$login_session' "))
				{
					...
					if ($result->num_rows > 0)
					{
						...
						echo '<td> <input  type="text" name="userName" class="demoInputBox" value="'.$row->username.'" maxlength="15"> </td>';
						echo '<td>(Max Χαρακτήρες: 15)</td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Κωδικός: </td>";
						echo '<td> <input type="text" name="password" class="demoInputBox" value="'.$row->password.'" maxlength="15"> </td>';
						echo '<td>(Max Χαρακτήρες: 15)</td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Όνομα: </td>";
						echo '<td> <input type="text" name="firstName" class="demoInputBox" value="'.$row->name.'" maxlength="50"> </td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Επώνυμο: </td>";
						echo '<td> <input type="text" name="lastName" class="demoInputBox" value="'.$row->surname.'" maxlength="50"> </td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Email: </td>";
						echo '<td> <input type="email" name="userEmail" class="demoInputBox" value="'.$row->email.'" > </td>';
						echo "</tr>";
						...
						<td style="padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;">
						<input type="radio" name="gender" value=Male <?php if(isset($_POST['gender']) && $_POST['gender']=="Male" || $row->gender =="Male") { ?>checked<?php  } ?>> Αρσενικό
						<input type="radio" name="gender" value=Female <?php if(isset($_POST['gender']) && $_POST['gender']=="Female" || $row->gender =="Female") { ?>checked<?php  } ?>> Θηλυκό
						</td>
						</tr>
						<?php
						...
						echo '<td> <input type="date" name="birth" class="demoInputBox" value="'.$row->birth.'" > </td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Α.Φ.Μ: </td>";
						echo '<td> <input type="number" name="AFM" class="demoInputBox" value="'.$row->AFM.'" max="999999999"> </td>';
						echo '<td>(9 ψηφία)</td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Α.Μ.Κ.Α: </td>";
						echo '<td> <input type="number" name="AMKA" class="demoInputBox" value="'.$row->AMKA.'" max="99999999999"> </td>';
						echo '<td>(11 ψηφία)</td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Τηλέφωνο: </td>";
						echo '<td> <input type="number" name="phone" class="demoInputBox" value="'.$row->phone.'" max="9999999999"> </td>';
						echo '<td>(10 ψηφία)</td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Πόλη: </td>";
						echo '<td> <input type="text" name="city" class="demoInputBox" value="'.$row->city.'" maxlength="40"> </td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Περιοχή: </td>";
						echo '<td> <input type="text" name="region" class="demoInputBox" value="'.$row->region.'" maxlength="40"> </td>';
						echo "</tr>";
						
						echo "<tr>";
						echo "<td style="."padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;".">Διεύθυνση: </td>";
						echo '<td> <input type="text" name="address" class="demoInputBox" value="'.$row->address.'" maxlength="40"> </td>';
						echo "</tr>";
						...
						<td style="padding-left:5px; font-size:13px; font-family:Georgia, Times, serif;">
						<input type="radio" name="group_type" value=Ασφαλισμένος <?php if(isset($_POST['group_type']) && $_POST['group_type']=="Ασφαλισμένος" || $row->group_type =="Ασφαλισμένος") { ?>checked<?php  } ?>> Ασφαλισμένος </br>
						<input type="radio" name="group_type" value=Συνταξιούχος <?php if(isset($_POST['group_type']) && $_POST['group_type']=="Συνταξιούχος" || $row->group_type =="Συνταξιούχος") { ?>checked<?php  } ?>> Συνταξιούχος
						</td>
						</tr>
						<?php
						...
						echo '<button name="update-user" style="margin:0px 40px;" type="submit" value="HTML" class="btnRegister">Αποθήκευση</button>
						</form> ';
						echo "</td></td>";
						echo "</tr>";
