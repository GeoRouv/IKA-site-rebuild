...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	<a href="./navigator.php" style="float:left; margin-bottom: 20px; text-decoration: none;" >&nbsp>Πλοηγός</a>
      ...
      <figure>
        <figcaption style="height:500px;">
			...
			<ul style="list-style-type:circle">
			  ...
			  <!-- NESTED LISTS HTML -->
				<ul style="list-style-type:circle">
					<li><a href="../insured/insured_services.php">Υπηρεσίες για Ασφαλισμένους</a></li>
					<ul style="list-style-type:circle">
						<li><a href="../insured/insured_applications.php">Αίτηση Ασφάλισης Τέκνου</a></li>
						<li><a href="../insured/insured_documents.php">Βεβαίωση Ενσήμων</a></li>
						<li><a href="../insured/insured_documents.php">Υπολογισμός Πλήθους Ενσήμων</a></li>
					</ul>
					<li><a href="../retired/retired_services.php">Υπηρεσίες για Συνταξιούχους</a></li>
					<ul style="list-style-type:circle">
						<li><a href="../retired/retired_applications.php">Αίτηση Συνταξιοδότησης</a></li>
						<li><a href="../retired/retired_documents.php">Βεβαίωση Σύνταξης</a></li>
						<li><a href="../retired/insured_documents.php">Υπολογισμός Ποσού Σύνταξης</a></li>
					</ul>
					<li><a href="../shops.php">Καταστήματα</a></li>
					<li><a href="../communication.php">Επικοινωνία</a></li>
					<li><a href="./FAQ.php">FAQ</a></li>
					<li><a href="./navigator.php">Πλοηγός</a></li>
				</ul>
