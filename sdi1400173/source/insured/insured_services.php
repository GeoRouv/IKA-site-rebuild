    ...
    <section id="slider" class="clear">
      <figure>
        <figcaption style="height:450px;">
			<h2><b>Ηλεκτρονικές Υπηρεσίες για Ασφαλισμένους</b></h2>
			<p>Επιλέξτε από τις ακόλουθες κατηγορίες την υπηρεσία που επιθυμείτε:</p>
			
			<p><a href="./insured_applications.php" style="padding: 30px 75px; background-color:#210B61;" class="button button2">Αίτηση Ασφάλισης Τέκνου</a></p>
			<p><a href="./insured_documents.php" class="button button2" style="margin:-50px 290px; padding: 30px 67px; background-color:#210B61;">Έκδοση Βεβαιώσης Ενσήμων</a></p>
			<p><a href="./stamps.php" class="button button2" style="margin:40px 290px; padding: 30px 59px; background-color:#210B61;">Υπολογισμός Πλήθους Ενσήμων</a></p>
